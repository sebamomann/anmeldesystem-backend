...
@Module({
    imports: [TypeOrmModule.forFeature([Appointment, Addition, File, Comment, Enrollment, Driver, Passenger, User, Session, Key, Mail, TelegramUser, PasswordReset, PasswordChange, EmailChange])],
