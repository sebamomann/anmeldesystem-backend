...
@Module({
    imports: [TypeOrmModule.forFeature([Driver, Addition, Enrollment, Appointment, File, User, Key, TelegramUser, PasswordReset, PasswordChange, EmailChange]), UserModule],
