...
@Module({
    imports: [TypeOrmModule.forFeature([Driver, Addition, Enrollment, Session, Appointment, File, User, Key, TelegramUser, PasswordReset, PasswordChange, EmailChange]), UserModule],
