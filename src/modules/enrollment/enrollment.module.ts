...
@Module({
    imports: [TypeOrmModule.forFeature([Enrollment, Appointment, Addition, File, Driver, Passenger, Comment, User, Session, Key, Mail, TelegramUser, PasswordReset, PasswordChange, EmailChange])],
